...
!(function (e) {
	...
	var n = 'undefined' != typeof window ? window : this,
		e = (n.Glider = function (e, t) {
			...
			i.track.classList.add('glider-track'), i.init(), (i.resize = i.init.bind(i, !0)), i.event(i.ele, 'add', { scroll: i.updateControls.bind(i) }), i.event(n, 'add', { resize: i.resize });
		}),
		t = e.prototype;
	return (
		(t.init = function (e, t) {
		...
		(t.bindArrows = function () {
			...
			i.opt.arrows
				? ['prev', 'next'].forEach(function (e) {
						...
						t && ('string' == typeof t && (t = document.querySelector(t)), t && ((t._func = t._func || i.scrollItem.bind(i, e)), i.event(t, 'remove', { click: t._func }), i.event(t, 'add', { click: t._func }), (i.arrows[e] = t)));
				  })
		...
		(t.updateControls = function (e) {
			...
			d.opt.rewind ||
				(d.arrows.prev &&
					(d.arrows.prev.classList.toggle('disabled', d.ele.scrollLeft <= 0 || t), d.arrows.prev.classList.contains('disabled') ? d.arrows.prev.setAttribute('aria-disabled', !0) : d.arrows.prev.setAttribute('aria-disabled', !1)),
				d.arrows.next &&
					(d.arrows.next.classList.toggle('disabled', Math.ceil(d.ele.scrollLeft + d.containerWidth) >= Math.floor(d.trackWidth) || t),
					d.arrows.next.classList.contains('disabled') ? d.arrows.next.setAttribute('aria-disabled', !0) : d.arrows.next.setAttribute('aria-disabled', !1))),
			...
			1 === Math.floor(d.opt.slidesToShow) && (h = 0),
				...
				[].forEach.call(d.slides, function (e, t) {
					...
					[].forEach.call(i, function (e) {
						...
						c === t || (h && h === t) ? i.add('center') : (i.remove('center'), i.add([t < c ? 'left' : 'right', Math.abs(t - (t < c ? c : h || c))].join('-')));
		...
		(t.destroy = function () {
			...
			var t = this,
				i = t.ele.cloneNode(!0);
			(i.children[0].outerHTML = i.children[0].innerHTML), e(i), [].forEach.call(i.getElementsByTagName('*'), e), t.ele.parentNode.replaceChild(i, t.ele), t.event(n, 'remove', { resize: t.resize }), t.emit('destroy');
		}),
		(t.emit = function (e, t) {
